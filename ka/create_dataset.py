...
class MSRSData(torch.utils.data.Dataset):
    def __init__(self, is_train=True, crop=lambda x: x):
        super(MSRSData, self).__init__()
        self.is_train = is_train
        if is_train:
            self.vis_folder =   "./images/vi/train/"
            self.ir_folder =   "./images/ir/train/"
        else:
            self.vis_folder =   "./images/vi/test/"
            self.ir_folder =   "./images/ir/test/"
...
class FusionData(torch.utils.data.Dataset):
    def __init__(self,  crop=lambda x: x):
