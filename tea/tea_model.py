...
def parse_args():
    ...
    parser.add_argument('--name', default='tea_model', help='model name: (default: arch+timestamp)')
...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        scheduler_f.step()
        if (epoch+1) % 10 == 0:
            torch.save(model.state_dict(), 'models/model_{}.pth'.format(epoch+1))
